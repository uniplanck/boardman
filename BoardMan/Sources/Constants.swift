...
struct Constants {
    ...
    struct UserDefaults {
        ...
        static let boardManItemRowHeight = "BoardManItemRowHeight"
        static let boardManSequentialPasteModeEnabled = "BoardManSequentialPasteModeEnabled"
        static let boardManSequentialPasteQueueJSON = "BoardManSequentialPasteQueueJSON"
        static let boardManSequentialPasteQueueCursor = "BoardManSequentialPasteQueueCursor"
        static let boardManSequentialPasteIncludesSelection = "BoardManSequentialPasteIncludesSelection"
        ...
        static let boardManSelectionCapturePreviewEnabled = "BoardManSelectionCapturePreviewEnabled"
        static let boardManSelectionCapturePreviewPosition = "BoardManSelectionCapturePreviewPosition"
        static let boardManSelectionCapturePreviewStyle = "BoardManSelectionCapturePreviewStyle"
        static let boardManSelectionMetadataPosition = "BoardManSelectionMetadataPosition"
        static let boardManSelectionAutoDeleteUsed = "BoardManSelectionAutoDeleteUsed"
        static let boardManSelectionThemePreset = "BoardManSelectionThemePreset"
        static let boardManSelectionUIStyle = "BoardManSelectionUIStyle"
        static let boardManSelectionFontChoice = "BoardManSelectionFontChoice"
        static let boardManSelectionItemTextScale = "BoardManSelectionItemTextScale"
        static let boardManSelectionItemRowHeight = "BoardManSelectionItemRowHeight"
        static let boardManSelectionThemeLighten = "BoardManSelectionThemeLighten"
        static let boardManSelectionUsedItemStyle = "BoardManSelectionUsedItemStyle"
        static let boardManSelectionCustomUsedColor = "BoardManSelectionCustomUsedColor"
        static let boardManSelectionCustomUsedOpacity = "BoardManSelectionCustomUsedOpacity"
        static let boardManSelectionRelativeNumberStyle = "BoardManSelectionRelativeNumberStyle"
        static let boardManSelectionRelativeUnitStyle = "BoardManSelectionRelativeUnitStyle"
        static let boardManSelectionRelativeSuffixStyle = "BoardManSelectionRelativeSuffixStyle"
        static let boardManSelectionRelativeNowStyle = "BoardManSelectionRelativeNowStyle"
        static let boardManSelectionCustomAccentColor = "BoardManSelectionCustomAccentColor"
        static let boardManSelectionCustomAccentOpacity = "BoardManSelectionCustomAccentOpacity"
        static let boardManSelectionCustomPanelColor = "BoardManSelectionCustomPanelColor"
        static let boardManSelectionCustomPanelOpacity = "BoardManSelectionCustomPanelOpacity"
        static let boardManSelectionTextPreviewScale = "BoardManSelectionTextPreviewScale"
        static let boardManPanelAlwaysOnTop = "BoardManPanelAlwaysOnTop"
        static let boardManPermissionOnboardingVersion = "BoardManPermissionOnboardingVersion"
        static let boardManAccessibilityPermissionRequested = "BoardManAccessibilityPermissionRequested"
        static let boardManInputMonitoringRequestFlag = "BoardManInputMonitoringPermissionRequested"
