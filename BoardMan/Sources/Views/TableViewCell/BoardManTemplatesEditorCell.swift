//
//  BoardManTemplatesEditorCell.swift
//
//  Clipy
...
final class BoardManTemplatesEditorCell: NSTextFieldCell {
    ...
    override func copy(with zone: NSZone?) -> Any {
        guard let cell = super.copy(with: zone) as? BoardManTemplatesEditorCell else { return super.copy(with: zone) }
