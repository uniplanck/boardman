...
- [Télécharger Board-Man v0.2.1](https://github.com/uniplanck/boardman/releases/tag/v0.2.1)
- Archive de l'app macOS : `Board-Man-v0.2.1.zip`

## Installation et premier lancement

1. Téléchargez `Board-Man-v0.2.1.zip` depuis la page de release.
