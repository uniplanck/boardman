...
Board-Man 面向日常工作中反复发生的复制、粘贴、编辑和文本移动场景。
...
当前版本仍是早期公开候选版本。可用发布版本如下:

- [Board-Man v1.2.3](https://github.com/uniplanck/boardman/releases/tag/v1.2.3)
- macOS app archive: `Board-Man-v1.2.3.zip`

解压后，将 `Board-Man.app` 移到 `/Applications` 并打开应用。如果 macOS Gatekeeper 在首次启动时拦截，请在 **System Settings > Privacy & Security** 中允许 Board-Man，或 Control 点击应用并选择 **Open**。

## 许可证与归属

Board-Man 是基于 Clipy 的修改派生版本。

原项目的 MIT 许可证声明和版权声明保留在以下文件中:

- `LICENSE`
- `LICENSE_CLIPMENU`
- `ATTRIBUTION.md`

Board-Man 不是 Clipy / ClipMenu 的官方项目，也不是其认可版本。
