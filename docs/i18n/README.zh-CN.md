...
> 发布状态：当前正式产品线为 **v0.1.0**。它是在旧 v1.2.3 实验版本之后有意重置版本号形成的新产品线；`main` 分支仍在持续开发，本翻译可能落后于英文 README。
...
- [下载 Board-Man v0.1.0](https://github.com/uniplanck/boardman/releases/tag/v0.1.0)
- macOS 应用归档：`Board-Man-v0.1.0.zip`

## 安装和首次启动

1. 从发布页面下载 `Board-Man-v0.1.0.zip`。
2. 解压归档文件。
